...
Skript ověří jeden zápis, tři replaye stejného klíče, dva paralelní klíče, jeden storno zápis, tři replaye storna, replay s jiným klíčem a návrat kreditu i přesné identity množiny všech dříve aktivních rezervací do výchozího stavu. Pouhá shoda počtu rezervací nestačí. Důkaz obsahuje pouze krátké SHA-256 otisky UAT lekce a rezervace, jejichž formát finální dossier znovu kontroluje. Po nejasném výsledku mutaci slepě neopakuje; booking se vypne a provede se reconciliation podle této příručky.
