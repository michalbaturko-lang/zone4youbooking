...
- Nejnovější lokální regrese 13. 9. po zabezpečení celého demo stavu prošla 215/215 jednotkovými a integračními testy, produkčním sestavením a 62/62 provedenými browser scénáři; 13 nevhodných kombinací bylo záměrně přeskočeno. Chromium i WebKit při simulovaně zablokovaném úložišti stále dokončily přihlášení, rezervaci a storno; poškozený stav se vrátí do bezpečného odhlášeného stavu. Tento výsledek nahrazuje předchozí lokální počty; veřejné Preview bude znovu ověřeno po nasazení přesného commitu.
