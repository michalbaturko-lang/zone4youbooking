...
- Novější doplněk regrese 13. 9. po přidání před-UAT validace resource mapy prošel 211/211 jednotkovými a integračními testy a 61/61 provedenými browser scénáři; 13 nevhodných kombinací projektu a scénáře bylo záměrně přeskočeno. Referenční mobil 390 × 844 zobrazil všech 37 položek rozšířeného feedu a dynamicky přidal nové sály bez overflow či ovládání pod 44 px. Tento výsledek nahrazuje počty v předchozím bodu.
