...
| Klientský REST drift | D1 na schváleném Zone4You HTTPS originu před loginem ověří stejných 11 dokumentačních stránek a stejný sémantický baseline; odchylka nevytvoří evidence | D1 evidence verze 5 + finální dossier validace |
