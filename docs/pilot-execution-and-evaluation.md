...
| Release dossier | přesný commit, aktivní launch okno, jmenovité potvrzení aktivních Luxart šablon a SHA-256 živých Luxart/runtime/UAT/rollback/alert/Memberzone důkazů projdou `verify:pilot-release` | privacy-safe JSON výstup finálního gate |
