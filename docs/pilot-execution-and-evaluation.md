...
- post-cutover ověřovač je pevně omezený na `booking.zone4you.cz`, celý schválený commit a launch fázi; bez loginu nebo mutace kontroluje skutečné DNS/HTTPS, runtime provenienci a úplný CS/EN produkční feed, přičemž do důkazu nevypíše DNS adresy ani ID lekcí.
