...
- **Nejnovější lokální regrese 13. 9.:** validace a paměťový fallback celého demo stavu spolu se zpřísněním UAT důkazů zvýšily sadu na 216/216 jednotkových a integračních testů; produkční sestavení a 62/62 provedených browser scénářů prošly, 13 nevhodných kombinací bylo záměrně přeskočeno. Chromium i WebKit simulují zablokované čtení, zápis a mazání úložiště a přesto dokončí přihlášení, rezervaci a storno; poškozený nebo nadlimitní stav se bezpečně zahodí a nikdy se neodešle na server. Mutační UAT před zápisem odmítá patologický kredit, cenu a storno pravidla a po zápisu vyžaduje omezené částky, explicitně zónované časy a výslovný storno poplatek včetně nuly. Tento bod nahrazuje předchozí lokální počty; externí důkaz následuje po nasazení přesného commitu.
