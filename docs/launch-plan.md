...
- bezpečný dossier preparátor automatizuje pouze kontrolu souborů a SHA-256; výstup je vždy nepřepisovatelný NO-GO draft a finální brána odmítne placeholder schvalující osoby, nepotvrzený alert i chybějící jmenovité potvrzení aktivních Luxart e-mailových šablon;
