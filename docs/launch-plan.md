...
**Novější doplněk regrese 13. 9.:** po přidání dynamického mobile-first feedu prošlo 61/61 provedených Playwright scénářů; 13 nevhodných kombinací projektu a scénáře bylo záměrně přeskočeno. Referenční mobil 390 × 844 prokázal úplné zobrazení 37 položek a automatické filtry pro dosud neznámé sály bez horizontálního overflow či ovládání pod 44 px. Tento výsledek nahrazuje browser počty v předchozím odstavci.
