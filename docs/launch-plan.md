...
Řízené mutační UAT povinně provede dva oddělené a plně obnovené scénáře nad různými výskyty: běžnou lekci a Reformer. Každý se zastaví ještě před prvním zápisem, pokud neodpovídá požadovanému typu, nemá explicitní personalizované povolení, autoritativní volné místo, validní mapovaný sál, otevřené rezervační okno nebo bezpečně dostupné online storno se shodným očekávaným poplatkem. Finální dossier odmítne chybějící typ, stejnou lekci v obou scénářích i opakované korelační ID; tyto předpodmínky proto nejsou jen operátorským checklistem.
