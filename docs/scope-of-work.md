...
1. **Luxart API** — port 9191 je domluvený ke zveřejnění pravděpodobně jako veřejný vstup na interní Luxart port 9759; čekáme na přesnou `/Help` URL, potvrzení této vazby, aktivního přístupu, test DB a auth režimu
