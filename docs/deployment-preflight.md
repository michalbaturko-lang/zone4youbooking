...
| Luxart | live režim, resort `1`, timeout 1–30 s, potvrzený gateway auth a HTTPS; testovací HTTP je možné pouze na stagingu s explicitní výjimkou, bez gateway credentials a pouze pro anonymní read-only rozvrh |
